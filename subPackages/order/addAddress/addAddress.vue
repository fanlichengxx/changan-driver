<template>
	<view>
		<Header title="添加地址" :PreventCollapse="true" :fontWeight="400" fontSize="32rpx" color="#000000"
			:fanhui="true" />
		<view class="box">
			...
			<view class="routeAddressBox">
				<view class="AddressInput">
					<view class="input_wrapper">
						<input placeholder="请填写地址" placeholder-style="fontSzie:24rpx;color:#A4A4A4;"
