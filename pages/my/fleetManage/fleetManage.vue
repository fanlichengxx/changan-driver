<template>
	<view>
		<!-- 导航栏 -->
		<u-navbar title="车队管理" :fixed="true" titleStyle="color:rgba(32, 32, 32, 1);font-size:36rpx;font-weight:bold"
		...
		<view v-if="Join==1">
			...
			<button class="btn" @click="submit('form')">解绑车队</button>
		</view>
		<!-- 车队栏 -->
	<view  v-else>
		<view class="main">
			...
			<view class="message">
				{{data.name}}邀请你加入{{data.fleetName}}车队，是否同意?
			</view>
			<view  style="height: 80RPX;"></view>
		</view>
	<button class="btn_SUN">同意加入</button>
	</view>
	</view>
</template>
